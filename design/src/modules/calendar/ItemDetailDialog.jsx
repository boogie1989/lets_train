  ...
  return (
    <>
      ...
      <div style={{
        ...
        boxShadow: shown ? '0 12px 32px rgba(var(--cs-shadow-rgb),0.6)' : 'var(--shadow-card)',
          ...
          <div style={{ padding: '16px 20px 14px', display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            {isWorkout ? (
              ...
              <div style={{ ...stagger(), display: 'flex', flexDirection: 'column', gap: 10 }}>
                <span style={{ ...TT, fontSize: 20, fontWeight: 500, color: 'var(--cs-on-surface)' }}>
...
function Stat({ label, value }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      <span style={{ ...TT, fontSize: 15, fontWeight: 500, color: 'var(--cs-on-surface)' }}>{value}</span>
