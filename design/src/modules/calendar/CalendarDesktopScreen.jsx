      ...
      <div style={{ flex: 1, minHeight: 0, display: 'flex' }}>
        ...
        <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', position: 'relative' }}>
          ...
          {/* Two columns: one app-style month + selected-day stats | centered
              timeline. The timeline CARDS match the calendar width (520); the
          ...
          <div style={{ flex: 1, minHeight: 0, display: 'flex', gap: 32, padding: '32px 32px 24px' }}>
            <div style={{ width: 520, flexShrink: 0, minHeight: 0, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ flex: 1, minWidth: 0, overflowY: 'auto', paddingBottom: 96, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
              {cal.items.length > 0 ? (
                <div style={{ width: 520 + 74, maxWidth: '100%' }}>
